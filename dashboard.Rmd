...
plt <- df %>%
  ...
  ggplot(aes(edad, a_favor, color = Genero, text = paste(Nombre,
                                                          '<br>Edad:',edad,
                                                         '<br>Cargo:',Cargo,
                                                         '<br>Partido:',Partido,
  ...
  labs(x= 'Edad', title = 'Probabilidad de votar a favor', subtitle = 'según edad y género')  
  
ggplotly(plt, tooltip = c('text'))
```


# Datos Diputados {.no-mobile}
