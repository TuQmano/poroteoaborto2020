...
arg <- get_grid("ARGENTINA") %>% 
  ...
  mutate(name = str_replace_all(name, 
                                pattern = " ", 
                                replacement = "\n"), 
         name_dip = paste0(name , " (", n , ")"))  # DESCARGO GRILLA DE ARGENTINA PARA GEOFACET
...
ggplot(dip_pct) +
  ...
  scale_fill_manual(values = c("#056e0c", "#62b567", "#941017", "#626c9e", "#000000", "#626c9e")) + #REVISAR PALETA DE COLORES
  ...
  theme(axis.ticks.x = element_blank(),
        axis.text.x = element_blank(), plot.margin = unit(c(0,-2 ,-6,-6), "mm"))  
...
ggplot(sen_pct) +
  geom_col(aes(pct, '',  fill = aborto_legal), width = 1, alpha = .7)  +
  scale_fill_manual(values = c("#056e0c", "#941017", "#626c9e", "#000000")) + # RESVISAR PALETA
