...
<font size="3"> [![](www/ecofemilogo.png){width=30px}](economiafeminita.com/) Un proyecto de [<span style="color: green;">Economia Feminita</span>](economiafeminita.com/) </font>

<font size="3"> [![](www/gsheetlogo.png){width=20px}](bit.ly/poroteoaborto2020) Datos de la [<span style="color: green;">planilla colaborativa</span>](bit.ly/poroteoaborto2020) </font>

<font size="3"> [![](www/lasdesistemas.svg){width=30px}](https://poroteosenado.herokuapp.com/) Resumen del poroteo por [<span style="color: green;">[LAS] de sistemas</span>](https://lasdesistemas.org/)  </font>
